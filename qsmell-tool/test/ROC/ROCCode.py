...

{
    ...
    CircuitInstruction(operation=Instruction(name=' Z', num_qubits=1, num_clbits=0, params=[]), qubits=(<Qubit register=(3, "q"), index=0>,), clbits=()), 
    ...
    CircuitInstruction(operation=Instruction(name=' Z', num_qubits=1, num_clbits=0, params=[]), qubits=(<Qubit register=(3, "q"), index=1>,), clbits=()), 
    ...
    CircuitInstruction(operation=Instruction(name=' Z', num_qubits=1, num_clbits=0, params=[]), qubits=(<Qubit register=(3, "q"), index=2>,), clbits=()), 
...
{'qc': [
    ...
    {'operation_name': 'h',
         ...
         'column_start': 4,
         'column_end': 29,
         'source_line': 'qc.append (hadamard, [j])'},
    ...
    {'operation_name': 'measure',
         ...
         'column_start': 4,
         'column_end': 38,
         'source_line': 'qc.append (measureQubit, [j], [j])'},
    ...
    {'operation_name': 'barrier',
         'qubits_affected': [0],
         'clbits_affected': [],
         'row': 19,
         'column_start': 0,
         'column_end': 13,
         'source_line': 'qc.barrier ()'}],
