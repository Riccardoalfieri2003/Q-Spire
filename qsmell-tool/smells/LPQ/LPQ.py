...
class LPQ(QuantumSmell):
    def __init__(self, row, col_start, col_end, circuit_name=None, explanation=None, suggestion=None):
        super().__init__("LPQ", row, col_start, col_end, explanation, suggestion, circuit_name)
